...
bool matchSearch(String value, String searchText) {
  final regExpStr =
      searchText.removeDiacritics().toLowerCase().replaceAll(' ', '');

  final paragraph = value.removeDiacritics().replaceAll(' ', '').toLowerCase();

  return RegExp(r'' + regExpStr + r'').hasMatch(paragraph);
}
